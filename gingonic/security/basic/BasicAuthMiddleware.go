...
// Middleware enables Basic authentication security to a gin.HandlerFunc
func Middleware(ptr gin.HandlerFunc, validateUser ValidateUserCallback) gin.HandlerFunc {
